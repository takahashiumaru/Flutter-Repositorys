...
class ProfileHandphone extends StatefulWidget {
  const ProfileHandphone({super.key});

  @override
  State<ProfileHandphone> createState() => _ProfileHandphone();
}

class _ProfileHandphone extends State<ProfileHandphone> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Edit No Handphone'),
      ),
      body: Column(

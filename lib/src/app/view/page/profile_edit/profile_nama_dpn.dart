...
class ProfileNamaDepan extends StatefulWidget {
  const ProfileNamaDepan({super.key});

  @override
  State<ProfileNamaDepan> createState() => _ProfileNamaDepan();
}

class _ProfileNamaDepan extends State<ProfileNamaDepan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Edit Nama Depan'),
      ),
      body: Column(
